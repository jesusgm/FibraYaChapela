...
export function HistorySection() {
  const glossaryItems = [
    ...
    },
    {
      ...
      element: (
        <>
          ...
          la misma red que los móviles. Funciona como un móvil gigante que da
          WiFi a toda la casa, pero puede ser lento si muchos gente lo usan a la
          vez o si la cobertura es mala.
        </>
      ),
    },
    {
      ...
      element: (
        <>
          ...
          las infraestructuras de fibra, lo que hace que otras empresas no
    ...
    },
    {
      ...
      element: (
        <>
          <strong>Red troncal:</strong> Son las "autopistas" principales de
          fibra óptica que recorren toda España llevando internet a alta
          velocidad. Desde estas autopistas salen "carreteras secundarias" que
    ...
    },
    {
      ...
      element: (
        <>
          <strong>Tendido de fibra:</strong> El proceso de instalar los cables
          de fibra óptica desde la red principal hasta las casas. Implica cavar
    ...
    },
    {
      ...
      element: (
        <>
          <strong>Subvención UNICO 2022:</strong> Un programa del gobierno que
          dio dinero público a empresas para llevar internet a zonas que no
          tenían buena conexión, como nuestro barrio.
        </>
      ),
    },
    {
      ...
      element: (
        <>
          ...
          necesarias para dar un servicio: cables, cajas, postes, antenas, etc.
          Es como los "huesos" del sistema de internet.
        </>
      ),
    },
  ];
  ...
  return (
    <Section id="history" className={styles.history}>
      <div>
        <h2>Historia</h2>
        <p>
          Muchos vecinos de nuestro barrio llevamos más de tres años en una
          lucha constante por conseguir un servicio que debería ser básico en el
          siglo XXI: la conexión a fibra óptica
          <sup>
            <a href="#2">2</a>
          </sup>
          ...
          técnica que nos mantiene completamente desconectados del mundo
          digital, afectando cada aspecto de nuestra vida cotidiana.
        </p>
        ...
        <p>
          ...
          completamente inviable, ya que la legislación vigente prohíbe cruzar
          la carretera nacional con infraestructuras
          <sup>
            <a href="#9">9</a>
          </sup>{" "}
        ...
        <p>
          ...
          convertido en un problema colectivo que afecta a cientos de familias.
          Lo curioso es que han rodeado su vivienda por detras pero ahora
          Movistar dice que no le compensa continuar con la instalación.
        </p>
        ...
        <p>
          ...
          argumentos de Movistar son puramente económicos: afirman que los
          costes para llevar la fibra hasta nuestro barrio no les compensa
          económicamente. Fuentes internas de la propia empresa nos han llegado
          a comentar que estarían hablando de costes que rondan los{" "}
          <strong>4 millones de euros</strong>, una cifra astronómica que
          desincentiva completamente cualquier inversión por su parte,
          dejándonos en un limbo digital absoluto.
        </p>
        ...
        <p>
          ...
          impotencia. Por un lado, no pueden conectar sus servicios a las CTOs
          de Movistar debido a las restricciones impuestas por el monopolio
          <sup>
            <a href="#5">5</a>
          </sup>{" "}
          de la infraestructura
          ...
          . Por otro lado, ninguna de estas empresas está dispuesta a realizar
          la inversión necesaria para desplegar su propia red de fibra
          <sup>
            <a href="#2">2</a>
          </sup>{" "}
        ...
        <p>
          ...
          descubierto lo que podría considerarse una verdadera burla a los
          vecinos del barrio. Según la página oficial del programa de despliegue
          de fibra del gobierno (
          <a
          ...
          afectados, <strong>AVATEL TELECOM S.A.</strong> fue la empresa que
          ganó una importante subvención
          <sup>
            <a href="#8">8</a>
          </sup>{" "}
          dentro del programa{" "}
          ...
          a zonas como la nuestra, es decir, a áreas con dificultades de
          conexión o sin servicio adecuado.
        </p>

        <p>
          Sin embargo, la realidad es completamente diferente a lo que figuraba
          en el proyecto. Si contactamos con <strong>AVATEL</strong> para
          solicitar el servicio, su respuesta es siempre la misma: nos informan
          de que <strong>no hay cobertura en nuestra zona</strong>. Lo más
          indignante ocurre cuando mencionamos la subvención específica que
          recibieron para nuestro barrio. En ese momento, o nos cuelgan
          directamente la llamada o simplemente dejan de responder a nuestros
          correos y mensajes. Esta actitud de la empresa demuestra un absoluto
          desprecio hacia los vecinos y hacia las obligaciones que contrajeron
          al aceptar dicha subvención
          <sup>
            <a href="#8">8</a>
          </sup>{" "}
          pública.
        ...
        <p>
          El resultado de toda esta concatenación de problemas es que nuestro
          barrio completo, en pleno siglo XXI, se mantiene sin acceso a una
          ...
          negocio, y <strong>familias</strong> que ven cómo su derecho
          fundamental a la conectividad se ve vulnerado sistemáticamente por
          intereses económicos, trabas administrativas y el desinterés de las
          empresas que recibieron fondos públicos precisamente para solucionar
          estos problemas.
        </p>
        ...
        <p>
          ...
          ), todos los ciudadanos tenemos derecho a un acceso adecuado a las
          redes y servicios de comunicaciones electrónicas. Sin embargo, las
          compañías se escudan en que al ofrecernos routers por radio
          <sup>
            <a href="#3">3</a>
          </sup>{" "}
          y routers 4G/5G
